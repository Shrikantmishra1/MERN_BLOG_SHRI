...
export const updateUser = async(req,res,next)=>{
    ...
    if(req.user.id !== req.params.userId){
         return next(errorHandler(402, 'You are not allowed to update this user..!'));
    ...
    if(!req.body.username.match(/^[a-zA-Z0-9]+$/)){
         return next(errorHandler(400, 'Username can only letters and numbers'));
